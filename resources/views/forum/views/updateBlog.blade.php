                ...
                <div class="col-md-12">
                    <div class="section-title text-center">
                        <div class="title-border">
                            <h1>update Blog<span> page</span></h1>
                        </div>
                                        ...
                                        <form action="https://designermachinefonts.net/dm/html/adventure/adventures/mail.php" method="post">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <img src="{{asset('uiFix/img/blog/large-1.jpg')}}" alt="">

                                                </div>
                                                <div class="col-md-12">
                                                    <label  class="submit-button container text-center" for="blogPicture">    update Image             </label>
